...
%
% Every pixel is drawn by Metal. GetMouse is Psychtoolbox, but it only reads the
% pointer; nothing here draws through Screen.
%
% Colours are 0 to 1 throughout, which is PsychMetal's convention for drawing.
%
...
try
 ...
 for k = 1:total
  ...
  PsychMetal('DrawLines', w, ...
      [0 rect(3) x x; y y 0 rect(4)], 2, [0.25 0.28 0.35]);
